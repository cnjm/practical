...
const dateFormat = (date, format, isUTC) => {
  ...
  const year = isUTC ? d.getUTCFullYear().toString() : d.getFullYear().toString();
  const month = isUTC ? (d.getUTCMonth() + 1).toString() : (d.getMonth() + 1).toString();
  ...
  const minute = isUTC ? d.getUTCMinutes().toString() : d.getMinutes().toString();
  const second = isUTC ? d.getUTCSeconds().toString() : d.getSeconds().toString();
  const millisecond = isUTC ? d.getUTCMilliseconds().toString() : d.getMilliseconds().toString();
